...
// Implement setPersistence with browserLocalPersistence immediately after initializing auth
try {
  setPersistence(auth, browserLocalPersistence).catch((err) => {
    console.warn('[FirebaseAuth] Initial setPersistence warning:', err)
  })
} catch (err) {
  console.warn('[FirebaseAuth] setPersistence exception:', err)
}
