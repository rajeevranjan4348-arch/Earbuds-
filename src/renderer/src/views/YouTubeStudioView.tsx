...
export const YouTubeStudioView: React.FC<YouTubeStudioViewProps> = ({ glassPanel = '' }) => {
  const [activeSubTab, setActiveSubTab] = useState<
    'PIPELINE' | 'TRENDS' | 'ANALYTICS' | 'SETTINGS'
  >('PIPELINE')
    ...
    try {
      ...
      if (jobsRes.success) {
        ...
        if (!selectedJob && jobsRes.jobs?.length > 0) {
          ...
          const updated = (jobsRes.jobs || []).find(
            (j: ContentJob) => j.jobId === selectedJob.jobId
          )
  ...
  return (
    <div className="flex flex-col min-h-full w-full max-w-7xl mx-auto space-y-4 text-zinc-100 font-sans select-none pb-12">
      ...
      <div
        className={`shrink-0 p-4 md:p-5 ${glassPanel} border border-white/10 bg-zinc-950/80 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-2xl relative`}
      >
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400 font-mono flex items-center gap-2 mt-0.5 flex-wrap">
              ...
              <span className="text-zinc-300">
                {profile?.subscribers.toLocaleString() || '18,450'} subscribers
              </span>
              <span>•</span>
      ...
      <div
        className={`shrink-0 p-3 md:p-4 ${glassPanel} border border-white/10 bg-zinc-950/70 rounded-2xl`}
      >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {activeSubTab === 'PIPELINE' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between gap-2 mb-1.5">
                          <span
                            className={`px-2 py-0.5 rounded text-[9px] font-mono font-bold uppercase border ${sColor.bg} ${sColor.text} ${sColor.border}`}
                          >
                            {job.stage.replace('_', ' ')}
                          </span>
                        ...
                        <div className="mt-2.5 flex items-center justify-between text-[10px] font-mono text-zinc-400">
                          <span>
                            Score:{' '}
                            <b className="text-emerald-400">{job.topic.opportunityScore}/100</b>
                          </span>
                          <span>
                            QC:{' '}
                            {job.qualityGatePassed ? (
                              <b className="text-emerald-400">PASSED</b>
                            ) : (
                              <b className="text-yellow-400">REVIEW</b>
                            )}
                          </span>
                        </div>
                      </motion.div>
              ...
              <div className="lg:col-span-7">
                {selectedJob ? (
                  <div
                    className={`p-5 ${glassPanel} border border-white/10 bg-zinc-950/80 rounded-2xl flex flex-col space-y-4 shadow-2xl`}
                  >
                    {/* Inspector Header */}
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <span
                            className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold uppercase border ${stageColors[selectedJob.stage]?.bg} ${stageColors[selectedJob.stage]?.text} ${stageColors[selectedJob.stage]?.border}`}
                          >
                            {selectedJob.stage}
                          </span>
                    ...
                    <div className="p-3.5 bg-zinc-900/90 border border-white/5 rounded-xl">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span
                          className={`text-[11px] font-mono font-bold ${selectedJob.qualityGatePassed ? 'text-emerald-400' : 'text-yellow-400'}`}
                        >
                          {selectedJob.qualityGatePassed
                      ...
                      <div className="p-3.5 bg-zinc-900/90 border border-white/5 rounded-xl space-y-3">
                        <div className="flex items-center justify-between border-b border-white/5 pb-2">
                          <span className="text-xs font-mono font-bold uppercase text-zinc-300 flex items-center gap-2">
                            ...
                            7-Part Script Architecture (~
                            {Math.round((selectedJob.script.estimatedDurationSec || 480) / 60)} min)
                          </span>
                          <span className="text-[10px] font-mono text-zinc-500">
                        ...
                        <div className="space-y-2 text-xs font-sans text-zinc-300 max-h-48 overflow-y-auto pr-1">
                          <div className="p-2 bg-zinc-950/60 rounded-lg border border-white/5">
                            ...
                            <span className="text-[9px] font-mono text-zinc-500">
                              Visual: {selectedJob.script.hook.visualCue}
                            </span>
                          </div>
                          ...
                          <div className="p-2 bg-zinc-950/60 rounded-lg border border-white/5">
                            ...
                            <p className="mt-0.5 text-zinc-200">
                              {selectedJob.script.context.text}
                            </p>
                          </div>
                          ...
                          <div className="p-2 bg-zinc-950/60 rounded-lg border border-white/5">
                            <span className="text-[10px] font-mono font-bold text-purple-400 uppercase">
                              4. Deep Dive Storytelling:
                            </span>
                            <p className="mt-0.5 text-zinc-200">
                              {selectedJob.script.storytelling.text}
                            </p>
                          </div>
                          ...
                          <div className="p-2 bg-zinc-950/60 rounded-lg border border-white/5">
                            ...
                            <p className="mt-0.5 text-zinc-200">
                              {selectedJob.script.conclusion.text}
                            </p>
                          </div>
                          ...
                          <div className="p-2 bg-zinc-950/60 rounded-lg border border-white/5">
                            ...
                            <p className="mt-0.5 text-zinc-200">
                              {selectedJob.script.callToAction.text}
                            </p>
                          </div>
                        </div>
                      </div>
                            ...
                            >
                              <div className="flex items-center justify-between font-mono font-bold text-[10px]">
                                ...
                                <span className="text-emerald-400">
                                  Score: {th.mobileReadabilityScore}%
                                </span>
                              </div>
                      ...
                      <div className="p-3 bg-zinc-900/90 border border-white/5 rounded-xl">
                        ...
                        <div className="space-y-1.5 max-h-40 overflow-y-auto text-[10px] font-mono text-zinc-400 pr-1">
                          {(selectedJob.assetManifest || []).map((asset) => (
                            <div
                              key={asset.assetId}
                              className="p-1.5 bg-zinc-950 rounded border border-white/5 flex items-center justify-between"
                            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-zinc-950/70 p-4 rounded-2xl border border-white/10">
                <div>
                  ...
                  <p className="text-xs text-zinc-400 font-mono">
                    Multidimensional opportunity scoring: Relevance, Demand, Low Competition,
                    Freshness & Audience Fit.
                  </p>
                </div>
                  ...
                  >
                    <div>
                      ...
                      <div className="mt-3 grid grid-cols-3 gap-1.5 text-[10px] font-mono text-zinc-400 border-t border-white/5 pt-2">
                        <div>
                          Demand: <b className="text-zinc-200">{topic.searchDemand}%</b>
                        </div>
                        <div>
                          Comp: <b className="text-zinc-200">{topic.competitionScore}%</b>
                        </div>
                        <div>
                          Fit: <b className="text-zinc-200">{topic.audienceFitScore}%</b>
                        </div>
                      </div>
                    </div>
          ...
          {/* 6. Tab 3: CHANNEL ANALYTICS & INSIGHTS (Recharts Dashboard) */}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {profile.contentNiches.map((n) => (
                        <span
                          key={n}
                          className="px-2 py-0.5 rounded-lg bg-zinc-900 border border-white/10 text-emerald-400 text-[11px]"
                        >
                          {n}
                        </span>
                      ))}
